...
export default function EmptyState({
  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 text-center ui-section-block-muted px-5">
      ...
      <p className="ui-eyebrow mb-2">Nothing Here Yet</p>
      <h3 className="text-[#103449] font-bold text-base mb-1">{title}</h3>
      <p className="text-[#4e6d80] text-sm max-w-xs">{message}</p>
