...
const LimestoneChecklist = memo(function LimestoneChecklist({ checkedItems, onToggle, uploadedFiles, onFileSelect }: LimestoneChecklistProps) {
  ...
  const handleToggleAll = () => {
    ...
    LIMESTONE_DOCUMENTS.forEach((doc) => {
