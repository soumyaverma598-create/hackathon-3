        ...
        <div className="w-full max-w-lg">
          ...
          >
            ...
            <div className="p-8">
              ...
              >
                {loginMode === 'official' ? 'Sign in to your account' : 'Applicant Sign In'}
              </h2>
              <p
                ...
                <div className="mb-2 animate-fade-slide-up" style={{ animationDelay: `${d + 0.2}s` }}>
                  <div className="space-y-2.5">
                    ...
                    >
                      ...
                      <span>{socialAuthLoading === 'Google' ? 'Connecting to Google…' : 'Continue with Google'}</span>
                    </button>
                    ...
                    >
                      ...
                      <span>{socialAuthLoading === 'Microsoft' ? 'Connecting to Microsoft…' : 'Continue with Microsoft (Company Mail)'}</span>
                    </button>
                    ...
                    >
                      ...
                      <span>Sign in with OTP (Mobile / Email)</span>
                    </button>
                  </div>
                  ...
                  <div className="relative my-4">
                    ...
                    <div className="relative flex justify-center">
                      <span className="bg-white px-3 text-xs text-gray-400">or continue with email & password</span>
                    </div>
                  </div>
                </div>
              )}
              ...
              {loginMode === 'applicant' && otpMode && (
                <div className="mb-5 animate-fade-slide-up" style={{ animationDelay: `${d + 0.2}s` }}>
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <span className="text-sm font-semibold text-gray-700">Sign in with OTP</span>
                  </div>
                  {!otpSent ? (
                    ...
                    <div className="space-y-3">
                      <p className="text-xs text-gray-500">OTP sent to <strong>{otpContact}</strong></p>
                      <p className="text-xs text-blue-600 bg-blue-50 border border-blue-100 rounded px-3 py-1.5">Demo hint — OTP: <strong>123456</strong></p>
                      <input
                        type="text"
                        value={otpCode}
